                    ...
                    <div class="card card_establishment">
                        <div class="card-body">
                            ...
                            <div class=" meconnecter pt-5">
                                <p class="">J’ai déjà un compte <a href="#" class="" data-toggle="modal" data-target="#Modallogin2"> Me connecter</a></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <form id="manager-login" method="post">
                    ...
                    <div class="">
                        ...
                        <div class=" meconnecter">
                            <p class="proxima-nove">Pas encore membre?<a href="#" id="inscrivez-modal" class="operRegister"> Inscrivez-vous</a></p>
                        </div>
                    </div>
                </form>
            </div>
                ...
                <div class="">
                    ...
                    <div>
                        <div class="row mt-3">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" placeholder="Prénom" class="form-control login-input inputicon2">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input type="text" placeholder="Téléphone" class="form-control login-input inputicon2">
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 text-center res-dec mt-3">
                                <div class=" meconnecter Connectez-vous">
                                    <p class="">Déjà membre?<a href="javascript:void(0);" data-toggle="modal" data-target="Modallogin2" id="openlogin2"> Connectez-vous</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-content">
            <div class="modal-body login-modal-body">
                <div class="">
                    ...
                    <div class="mb-20">
                        <div class="form-group">
                            <input type="text" placeholder="Email / Nom d'utilisateur*" class="form-control  login-input inputicon2">
                        </div>
                    </div>
                    <div class="mb-20">
                        <div class="form-group sr-rel">
                            <input type="password" placeholder="Mot de passe*" class="form-control  login-input inputicon2 sr-rel" id="password">
                            <img src="{{asset('frontend/images/about/eye.svg')}}" alt="" class="sr-eye" id="toggle-password">
                        </div>
                    </div>
...
<script>
    ...
    //----------------
    $('.operRegister').on('click', '.operRegister', function() {
    ...
    $("#inscrivez-modal").on('click', function() {
        $('#Modallogin2').modal('hide');
        $('#header-Modallogin1').modal('show');
        setTimeout(function() {
            $('body').addClass('modal-open');
