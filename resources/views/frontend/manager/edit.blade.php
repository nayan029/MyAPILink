            ...
            <div class="row profile-top jus-res">
                <div class="col-lg-3 col-md-4 col-9">
                    ...
                    <div class="profile-img bg-manager">
                        <img src="images/project/mont1.svg" alt="profile image">
                    </div>
                </div>
                <div class="col-md-8">
                    <div class="mb-3 mt-3 profile" id="manager-id">
                        <h4 class="profile-name">Mairie de Montpellier <img src="images/imgs-svg/edit-icon.svg" alt="edit" class="ml-1 edit-manager"></h4>
                        <p class="mb-0 d-flex align-items-center">31 avenue de la liberté 34000 Montpellier <img src="images/imgs-svg/edit-icon.svg" alt="edit" class="edit-manager ml-2"></p>
                                    ...
                                    <div class="card sr-card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex justify-content-end">
                                                <button class="btn btn-yellow d-flex align-items-center pd-btns-edit"><img
                                                        src="images/imgs-svg/edit-icon.svg" alt="edit"
                                                ...
                                                <div class="card sr-card manager-card">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <img src="images/project/plus.svg" alt="plus" class="plus-manager">
                                                            <p class="mb-0 un-textp">Ajouter un établissement petite enfance
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card-body">
                                                    <table class="manager-table">
                                                        <tr>
                                                            <td>
                                                                <div class="d-flex align-items-center">
                                                                    <img src="images/project/user-detail-pro.svg" alt="user" class="manager-pro mr-3">
                                                        ...
                                                        <div class="row mb-3 ">
                                                            ...
                                                            <div class="col-md-4 d-flex align-items-end mb-3">
                                                                <div class="metters-btns">
                                                                    ...
                                                                    <a href="web-1920.html" class="btn btn btn-met">
                                                                        Modifier
                                                                    </a>
