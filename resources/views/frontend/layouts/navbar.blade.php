        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav header-ul ml-auto">
                    <li class="nav-item ">
                        <!--active-->
                        <a class="nav-link" href="{{route('applyJob')}}">Rechercher un emploi<span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
                ...
                <ul class="navbar-nav header-ul custom-header-drop  ml-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            ...
                            <a class="dropdown-item" href="{{route('applyJob')}}"> <img src="{{asset('frontend/images/project/search.svg')}}">Rechercher un
                                job</a>
