    ...
    <section class="back-f6 pt-2 pb-5">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="m-3">
                        <a href="search-for-ad.html" class="back link_a">
                                ...
                                <div class="col-md-7 mt-3 mb-3">
                                    <div class="c-profile-sec">
                                        <div class="d-flex align-items-center">
                                            <img src="images/imgs-svg/view-profile.svg" alt="candidate-profile" class="c-profimage">
                                            <div class="pl-3">
                                                <h5 class="dark-tit">Monsieur Paul Bertrand</h5>
                                                <div class="c-prof-headertext">
                                                    <p class="mb-0">Auxiliaire de crèche</p>
                                                    <p class="mb-0">
                                                        <span><img src="images/map.svg" width="12px"></span> Montpellier, France
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-5 portfolio-headright">
                                    ...
                                    <div class="d-flex">
                                        <div class="view-profbtn mr-4">
                                            <span> <img src="images/imgs-svg/green-check.svg" alt=""
                                                    class="mr-2"></span> Profil vérifié
                                        </div>
                                    ...
                                    <div class="profile-sidebar-sec">
                                        ...
                                        <div class="prof-side">
                                            ...
                                            <ul class="prof-viewcheck-ul">
                                                <li> <span><img src="images/imgs-svg/blue-md-checkmark.svg"
                                                            alt=""></span> 0-1 an
                                                </li>
                                                <li> <span><img src="images/imgs-svg/blue-md-checkmark.svg"
                                                            alt=""></span> 2-3 an
                            ...
                            <div class="card sr-card ">
                                <ul class="nav connection-tab edit-line-tab tab-cardul2" id="myTab" role="tablist">
                                    <li class="nav-item">
                                        ...
                                        portfolio-profile-tab" data-toggle="tab" href="#portfolio-profile" role="tab" aria-controls="home" aria-selected="true"><svg
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="portfolio3-tab" data-toggle="tab" href="#Portfolio3" role="tab" aria-controls="home" aria-selected="true"><svg
                                                xmlns="http://www.w3.org/2000/svg" width="31.788" height="31.79"
                                                viewBox="0 0 31.788 31.79">
                                                <g id="Group_412" data-name="Group 412"
                                                    transform="translate(-659.637 -659.617)">
                                                    <path id="Path_3745" class="paths-svg" data-name="Path 3745"
                                                        ...
                                                        transform="translate(0)" fill="#7d7d7d" stroke="#707070"
                                                        stroke-width="0.2">
                                                    </path>
                                                    <path id="Path_3746" class="paths-svg" data-name="Path 3746"
                                                        d="M988.142,814.126h-1.009v-4.174h1.009Z"
                                                        transform="translate(-302.102 -138.628)" fill="#7d7d7d"
                                                        stroke="#707070" stroke-width="0.2"></path>
                                                    <path id="Path_3747" class="paths-svg" data-name="Path 3747"
                                                        ...
                                                        transform="translate(-119.554 -213.735)" fill="#7d7d7d"
                                                        stroke="#707070" stroke-width="0.2"></path>
                                                </g>
                                            </svg>Portfolio</a>
                                    </li>
                                        ...
                                        <div class="dossier_sec personal_detail_edit">
                                            <ul class="img-ul">
                                                ...
                                                <li>
                                                    <div class="img_section">
                                                        <div class="img_content img-space">
                                                            <img src="images/imgs-svg/unsplash1.svg" />
                                                        </div>
                                                ...
                                                <li>
                                                    <div class="img_section">
                                                        <div class="img_content img-space">
                                                            <img src="images/imgs-svg/unsplash2.svg" />
                                                        </div>
                                                ...
                                                <li>
                                                    <div class="img_section">
                                                        <div class="img_content img-space">
                                                            <img src="images/imgs-svg/unsplash4.svg" />
                                                        </div>
                                                ...
                                                <li>
                                                    <div class="img_section">
                                                        <div class="img_content img-space">
                                                            <img src="images/imgs-svg/unsplash8.svg" />
                                                        </div>
                                                ...
                                                <li>
                                                    <div class="img_section">
                                                        <div class="img_content img-space">
                                                            <img src="images/imgs-svg/unsplash9.svg" />
                                                        </div>
                                                ...
                                                <li>
                                                    <div class="img_section">
                                                        <div class="img_content img-space">
                                                            <img src="images/imgs-svg/unsplash10.svg" />
                                                        </div>
                                            ...
                                            <div class="d-flex justify-content-end btn-image-view mt-4">
                                                <a class="btn btn-blue d-flex"><img src="images/imgs-svg/ionic-md-eye.svg" class="mr-4" alt="eye-icon">Plus ...</a>
                                            </div>
                                        </div>
