    ...
    <section class="back-f6 pt-2 pb-5">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="m-3">
                        <a href="find-candidate.html" class="back link_a">
                                ...
                                <div class="col-md-5 portfolio-headright">
                                    ...
                                    <div class="d-flex">
                                        <div class="view-profbtn mr-4">
                                            <span> <img src="{{asset('frontend/images/imgs-svg/green-check.svg')}}" alt="" class="mr-2"></span> Profil vérifié
                                        </div>
                                        <div class="view-profbtn">
                                            <span> <img src="{{asset('frontend/images/imgs-svg/greendot.png')}}" alt="" class="mr-2"></span> Disponible
                                        </div>
                                    </div>
